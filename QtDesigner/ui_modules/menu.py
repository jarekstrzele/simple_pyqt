...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(870, 1079)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.splitter = QtWidgets.QSplitter(self.centralwidget)
        self.splitter.setGeometry(QtCore.QRect(20, 120, 600, 800))
        ...
        self.actionQMessagebox = QtWidgets.QAction(MainWindow)
        self.actionQMessagebox.setObjectName("actionQMessagebox")
        ...
        self.menuFile.addSeparator()
        self.menuDialog.addAction(self.actionQMessagebox)
        ...
        self.toolBar.addAction(self.actionQFileDialog)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen.setToolTip(_translate("MainWindow", "Click her for a new project"))
        self.actionOpen.setStatusTip(_translate("MainWindow", "new Project"))
        ...
        self.actionQMessagebox.setText(_translate("MainWindow", "QMessagebox"))
        ...
        self.actionAbout_menu.setText(_translate("MainWindow", "To jest tekxt heo"))
        self.actionAbout_menu.setIconText(_translate("MainWindow", "to jest icon text"))
        self.actionAbout_menu.setToolTip(_translate("MainWindow", "helo toolTIp"))
